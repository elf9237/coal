    ...
    Slider.prototype = {
        ...
        bindDragEvent: function() {
            ...
            function success() {
                ...
                $container.find('span').css({"color":"#fff"});
                $container.find('.slide-to-unlock-handle').addClass("success");
                // $container.find(".slide-to-unlock-bg span").css({"textIndent":"0px","marginRight":"40px"});
